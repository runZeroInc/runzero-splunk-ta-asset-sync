...
1. Install `uv` if you don't already have it: `brew install uv` (or see the [uv install docs](https://docs.astral.sh/uv/getting-started/installation/)).
...
predict upcoming compatibility loss).
```sh
cd appinspect
